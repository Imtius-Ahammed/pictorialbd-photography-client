...
const ServiceDetails = () => {
  ...
  const { title, _id, img, price, ratings, views, description } =
    serviceDetails;
  console.log(_id);
            ...
            <section className="text-gray-600 body-font relative">
              <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                  <img
                    src="https://img.freepik.com/free-vector/organic-flat-feedback-concept_52683-62653.jpg?w=1380&t=st=1668065730~exp=1668066330~hmac=7b36da9df98a3eea53add9388cb3c6e1783ebdf4ed3ab00e3ce67e1c8cba39d7"
                    alt=""
                  />
                </div>
